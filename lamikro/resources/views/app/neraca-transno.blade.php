...
<html lang="id">
    ...
    <body class="header-fixed">
                    ...
                    <div class="content-viewport">
						<div class="pb-2 d-flex justify-content-md-start justify-content-center">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="../../laporan-posisi-keuangan" class="text-danger">Laporan Posisi Keuangan</a></li>
								<li class="list-inline-item">></li>
								<li class="list-inline-item text-muted date">Transno</li>
							</ul>
						</div>
					                ...
					                <table class="table table-hover">
					                    <thead>
					                        <tr>
					                            ...
					                            <th class="font-weight-bold text-right">Tanggal</th>
					                    ...
					                    <tbody id="dataJournalEntry">
											<tr>
												<td><h6>Total</h6></td>
												<td colspan="2" class="text-right"><h6 id="totalDebit"></h6></td>
												<td class="text-right"><h6 id="totalKredit"></h6></td>
												<td></td>
											</tr>
					                    </tbody>
					                </table>
        ...
        <script type="text/javascript">const transno = '{{Request::route("transno")}}'</script>
        <script type="text/javascript" src="{{asset('vendor/jquery/number.js')}}"></script>
        <script type="text/javascript" src="{{asset('api/neraca-transno.js')}}"></script>
    </body>
</html>