					                    ...
					                    <div class="col col-xl-10 py-2">
					                        <div class="card">
					                            <div class="card-body">
					                                ...
					                                <h6 class="pb-3">Versi 3.1 (2021)</h6>
					                                <ol class="pl-4">
					                                    <li>Pelengkapan data profil dan profil usaha pengguna.</li>
					                                    <li>Akses dibuat lebih cepat.</li>
					                                    <li>Penambahan akun statistik dan profil admin untuk Kementerian Koperasi dan Usaha Kecil dan Menengah Republik Indonesia.</li>
					                                </ol>
					                            </div>
					                        </div>
					                    </div>
