...
<html lang="id">
    ...
    <body class="header-fixed">
                    			...
                    			<div class="table-responsive">
					                <table class="table table-hover">
					                    ...
					                    <tbody id="dataJournalEntry">
											<tr>
												<td class="font-weight-bold" style="font-size:15px">Saldo Awal</td>
												<td class="font-weight-bold text-right" id="saldoAwalDebit" style="font-size:15px">0</td>
												<td class="font-weight-bold text-right" id="saldoAwalKredit" style="font-size:15px">0</td>
												<td></td>
											</tr>
					                    </tbody>
					                </table>
        ...
        <script type="text/javascript" src="{{asset('api/neraca-account.js')}}"></script>
    </body>
</html>